...
| Path | What |
|---|---|
| `specline-2.6.md` | The current canon (`2.6.2`). The governing rulebook. Stays at repo root — the site and CLI resolve it by globbing `specline-*.md` here. |
...
implement (`doctor@2.6` ↔ canon `2.6.2`). The contract moves first; tooling
