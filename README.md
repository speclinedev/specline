...
| Path | What |
|---|---|
| `specline-2.7.md` | The current canon (`2.7.0`). The governing rulebook. Stays at repo root — the site and CLI resolve it by globbing `specline-*.md` here. |
...
implement (`doctor@2.7` ↔ canon `2.7.0`). The contract moves first; tooling
